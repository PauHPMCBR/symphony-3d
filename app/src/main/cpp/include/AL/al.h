 ...
 * Range: [0.0 - ]
 *
 * For fileSources, an initial linear gain value (before attenuation is applied).
 ...
 * removed with alSourceUnqueueBuffers.
 *
 * Looping fileSources will never fully process buffers because they will be set to
 ...
 *
 * The model by which fileSources attenuate with distance.
 *
